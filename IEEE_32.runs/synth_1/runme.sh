...
HD_PWD='C:/Users/aniru/.Xilinx/Code/Vivado/IEEE_32_FPU/BFloat_16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FloatingSqrt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FloatingSqrt.tcl
